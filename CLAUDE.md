...
- `mcp/README.md` — MCP server installation commands (Playwright, shadcn/ui, Figma, Next.js DevTools, TanStack)
- `skills/README.md` — Skills CLI usage and installed skills (Vercel React Best Practices, Next.js Best Practices, Next.js Upgrade, Vercel Composition Patterns, Web Design Guidelines, SEO Audit), plus AGENTS.md guidance
